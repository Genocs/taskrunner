...
namespace Genocs.TaskRunner.Service
{
    public static class ServiceStartup
    {
        ...
        public static void ConfigureServices(HostBuilderContext context, IServiceCollection services)
        {
            ...
            services.Configure<WorkflowServiceOptions>(context.Configuration.GetSection("WorkflowServiceOptions"));
            ...
            services
                ...
                {
                    c.BaseAddress = new Uri(context.Configuration["SERVICE_URI_MEMBER"]);
                })
            ...
            services
                ...
                {
                    c.BaseAddress = new Uri(context.Configuration["SERVICE_URI_VALIDATION"]);
